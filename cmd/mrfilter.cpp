...
const OptionGroup FFTOption =
    OptionGroup("Options for FFT filter")
...
const OptionGroup GradientOption =
    OptionGroup("Options for gradient filter")
...
const OptionGroup SmoothOption =
    OptionGroup("Options for smooth filter")
...
const OptionGroup ZcleanOption =
    OptionGroup("Options for zclean filter") +
...
void usage() {
  ...
  OPTIONS
  +FFTOption + GradientOption + MedianOption + NormaliseOption + SmoothOption + ZcleanOption +
      Stride::Options;
}
