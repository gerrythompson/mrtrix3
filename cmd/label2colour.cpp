...
void usage() {
  ...
  DESCRIPTION
  +"Many software packages handle this colouring internally within their viewer program; this "
   "binary "
   "explicitly converts a parcellation image into a colour image that should be viewable in any "
   "software.";
