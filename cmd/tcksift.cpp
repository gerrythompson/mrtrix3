...
void usage() {
  ...
  SYNOPSIS = "Filter a whole-brain fibre-tracking data set such that the streamline densities "
  ...
  +Option("nofilter",
          "do NOT perform track filtering - just construct the model in order to provide output "
          "debugging images")

      + Option("output_at_counts",
               "output filtered track files (and optionally debugging images if -output_debug is "
               "specified) at specific "
