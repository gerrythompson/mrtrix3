...
void usage() {
  ...
  +Option("padding", " boundary box padding in voxels. Default: " + str(PADDING_DEFAULT)) +
      ...
      Option("resolution",
             ...
             "Valid options are 'mean': unbiased but loss of resolution for individual images "
             "possible, "
             "and 'max': smallest voxel size of any input image defines the resolution. Default: "
             "mean") +
