...
signals:
  void SyncDataReceived(vector<std::shared_ptr<QByteArray>>
                            data); // fires when data is received which is for syncing. It is up to
                                   // listeners to validate and store this value
