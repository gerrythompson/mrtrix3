...
ODF_Preview::RenderFrame::RenderFrame(QWidget *parent) : DWI::RenderFrame(parent) {
...
ODF_Preview::ODF_Preview(ODF *parent)
  ...
  connect(lock_orientation_to_image_box,
          SIGNAL(stateChanged(int)),
          this,
          SLOT(lock_orientation_to_image_slot(int)));
  ...
  connect(
      level_of_detail_selector, SIGNAL(valueChanged(int)), this, SLOT(level_of_detail_slot(int)));
