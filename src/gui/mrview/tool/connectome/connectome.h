...
private:
  ...
  node_property_matrix_operator_t node_colour_matrix_operator, node_size_matrix_operator,
      node_alpha_matrix_operator;
  ...
  void
  update_controls(AdjustButton *const, AdjustButton *const, const float, const float, const float);
