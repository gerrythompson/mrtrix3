...
NodeSelectionSettings::NodeSelectionSettings()
  ...
  node_selected_visibility_override =
      File::Config::get_bool("ConnectomeNodeSelectedVisibilityOverride", true);
  // CONF option: ConnectomeNodeSelectedColourFade
  // CONF default: 0.75
  // CONF The fraction of the colour of a selected node determined by the fixed selection highlight
  // CONF colour.
  ...
  File::Config::get_RGB(
      "ConnectomeNodeSelectedColour", node_selected_colour.data(), 1.0f, 1.0f, 1.0f);
  // CONF option: ConnectomeNodeSelectedSizeMultiplier
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the size of selected nodes.
  node_selected_size_multiplier =
      File::Config::get_float("ConnectomeNodeSelectedSizeMultiplier", 1.0f);
  ...
  node_selected_alpha_multiplier =
      File::Config::get_float("ConnectomeNodeSelectedAlphaMultiplier", 1.0f);
  ...
  edge_selected_visibility_override =
      File::Config::get_bool("ConnectomeEdgeSelectedVisibilityOverride", false);
  // CONF option: ConnectomeEdgeSelectedColourFade
  // CONF default: 0.5
  // CONF The fraction of the colour of an edge connected to two selected nodes determined by the
  // CONF fixed selection highlight colour.
  ...
  File::Config::get_RGB(
      "ConnectomeEdgeSelectedColour", edge_selected_colour.data(), 0.9f, 0.9f, 1.0f);
  ...
  edge_selected_size_multiplier =
      File::Config::get_float("ConnectomeEdgeSelectedSizeMultiplier", 1.0f);
  // CONF option: ConnectomeEdgeSelectedAlphaMultiplier
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the transparency of edges connected to
  // CONF two selected nodes.
  edge_selected_alpha_multiplier =
      File::Config::get_float("ConnectomeEdgeSelectedAlphaMultiplier", 1.0f);

  //////////////////////////////////////////////////////////////////////

  // CONF option: ConnectomeNodeAssociatedColourFade
  // CONF default: 0.5
  // CONF The fraction of the colour of an associated node determined by the fixed associated
  ...
  File::Config::get_RGB(
      "ConnectomeNodeAssociatedColour", node_associated_colour.data(), 0.0f, 0.0f, 0.0f);
  ...
  node_associated_size_multiplier =
      File::Config::get_float("ConnectomeNodeAssociatedSizeMultiplier", 1.0f);
  // CONF option: ConnectomeNodeAssociatedAlphaMultiplier
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the transparency of nodes associated with
  // CONF a selected node.
  node_associated_alpha_multiplier =
      File::Config::get_float("ConnectomeNodeAssociatedAlphaMultiplier", 1.0f);

  // CONF option: ConnectomeEdgeAssociatedColourFade
  // CONF default: 0.5
  // CONF The fraction of the colour of an edge connected to one selected node determined by the
  // CONF fixed colour.
  ...
  File::Config::get_RGB(
      "ConnectomeEdgeAssociatedColour", edge_associated_colour.data(), 0.0f, 0.0f, 0.0f);
  ...
  edge_associated_size_multiplier =
      File::Config::get_float("ConnectomeEdgeAssociatedSizeMultiplier", 1.0f);
  // CONF option: ConnectomeEdgeAssociatedAlphaMultiplier
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the transparency of edges connected to one selected
  // CONF node.
  edge_associated_alpha_multiplier =
      File::Config::get_float("ConnectomeEdgeAssociatedAlphaMultiplier", 1.0f);

  //////////////////////////////////////////////////////////////////////

  // CONF option: ConnectomeNodeOtherVisibilityOverride
  // CONF default: false
  // CONF Whether or not nodes are forced to be invisible when not selected or associated with any
  // CONF selected node.
  node_other_visibility_override =
      File::Config::get_bool("ConnectomeNodeOtherVisibilityOverride", false);
  // CONF option: ConnectomeNodeOtherColourFade
  // CONF default: 0.75
  // CONF The fraction of the colour of an unselected, non-associated node determined by the fixed
  // CONF not-selected highlight colour.
  node_other_colour_fade = File::Config::get_float("ConnectomeNodeOtherColourFade", 0.75f);
  // CONF option: ConnectomeNodeOtherColour
  // CONF default: 0.0,0.0,0.0
  // CONF The colour mixed in to those nodes currently not selected nor associated with any selected
  // CONF node.
  ...
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the size of nodes not currently selected nor
  // CONF associated with a selected node.
  ...
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the transparency of nodes not currently selected nor
  // CONF associated with a selected node.
  ...
  edge_other_visibility_override =
      File::Config::get_bool("ConnectomeEdgeOtherVisibilityOverride", true);
  // CONF option: ConnectomeEdgeOtherColourFade
  // CONF default: 0.75
  // CONF The fraction of the colour of an edge not connected to any selected node determined by the
  // CONF fixed colour.
  ...
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the size of edges not connected to any selected
  // CONF node.
  ...
  // CONF default: 1.0
  // CONF The multiplicative factor to apply to the transparency of edges not connected to any
  // CONF selected node.
  edge_other_alpha_multiplier = File::Config::get_float("ConnectomeEdgeOtherAlphaMultiplier", 1.0f);
}

NodeSelectionSettingsFrame::NodeSelectionSettingsFrame(QWidget *parent,
  ...
  connect(node_selected_visibility_checkbox,
          SIGNAL(stateChanged(int)),
          this,
          SLOT(node_selected_visibility_slot()));
  ...
  connect(node_selected_colour_slider,
          SIGNAL(valueChanged(int)),
          this,
          SLOT(node_selected_colour_fade_slot()));
  ...
  connect(
      node_selected_alpha_button, SIGNAL(valueChanged()), this, SLOT(node_selected_alpha_slot()));
  ...
  connect(edge_selected_visibility_checkbox,
          SIGNAL(stateChanged(int)),
          this,
          SLOT(edge_selected_visibility_slot()));
  ...
  connect(edge_selected_colour_slider,
          SIGNAL(valueChanged(int)),
          this,
          SLOT(edge_selected_colour_fade_slot()));
  ...
  connect(
      edge_selected_alpha_button, SIGNAL(valueChanged()), this, SLOT(edge_selected_alpha_slot()));
  ...
  node_associated_colour_slider->setSliderPosition(settings.get_node_associated_colour_fade() *
                                                   100.0f);
  connect(node_associated_colour_slider,
          SIGNAL(valueChanged(int)),
          this,
          SLOT(node_associated_colour_fade_slot()));
  ...
  connect(
      node_associated_colour_button, SIGNAL(clicked()), this, SLOT(node_associated_colour_slot()));
  ...
  connect(
      node_associated_size_button, SIGNAL(valueChanged()), this, SLOT(node_associated_size_slot()));
  ...
  connect(node_associated_alpha_button,
          SIGNAL(valueChanged()),
          this,
          SLOT(node_associated_alpha_slot()));
  ...
  edge_associated_colour_slider->setSliderPosition(settings.get_edge_associated_colour_fade() *
                                                   100.0f);
  connect(edge_associated_colour_slider,
          SIGNAL(valueChanged(int)),
          this,
          SLOT(edge_associated_colour_fade_slot()));
  ...
  connect(
      edge_associated_colour_button, SIGNAL(clicked()), this, SLOT(edge_associated_colour_slot()));
  ...
  connect(
      edge_associated_size_button, SIGNAL(valueChanged()), this, SLOT(edge_associated_size_slot()));
  ...
  connect(edge_associated_alpha_button,
          SIGNAL(valueChanged()),
          this,
          SLOT(edge_associated_alpha_slot()));
  ...
  connect(node_other_visibility_checkbox,
          SIGNAL(stateChanged(int)),
          this,
          SLOT(node_other_visibility_slot()));
  ...
  connect(node_other_colour_slider,
          SIGNAL(valueChanged(int)),
          this,
          SLOT(node_other_colour_fade_slot()));
  ...
  connect(edge_other_visibility_checkbox,
          SIGNAL(stateChanged(int)),
          this,
          SLOT(edge_other_visibility_slot()));
  ...
  connect(edge_other_colour_slider,
          SIGNAL(valueChanged(int)),
          this,
          SLOT(edge_other_colour_fade_slot()));
...
NodeSelectionSettingsDialog::NodeSelectionSettingsDialog(QWidget *,
  ...
  QPushButton *close_button =
      new QPushButton(style()->standardIcon(QStyle::SP_DialogCloseButton), tr("&Close"));
