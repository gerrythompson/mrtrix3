...
public:
  ...
  int slice() const {
    if (!image())
      ...
      return std::round(
          (image()->image.transform().inverse().cast<float>() * focus())(anatomical_plane) /
...
private:
  ...
  QAction *save_action, *close_action, *properties_action,
      ...
      **tool_actions, *invert_scale_action, *extra_controls_action, *snap_to_image_action,
      *image_hide_action, *next_image_action, *prev_image_action, *next_image_volume_action,
      *prev_image_volume_action, *goto_image_volume_action, *next_slice_action, *prev_slice_action,
      *reset_view_action, *next_image_volume_group_action, *prev_image_volume_group_action,
      *goto_image_volume_group_action, *wrap_volumes_action, *image_list_area,

      *reset_windowing_action, *axial_action, *sagittal_action, *coronal_action,

      *toggle_annotations_action, *show_comments_action, *show_voxel_info_action,
      *show_orientation_labels_action, *show_crosshairs_action, *show_colourbar_action,
      *image_interpolate_action, *full_screen_action,
