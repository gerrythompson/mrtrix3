...
inline std::string
get_image(QWidget *parent, const std::string &caption, std::string *folder = nullptr) {
  return get_file(parent, caption, image_filter_string, folder);
}

inline vector<std::string>
get_images(QWidget *parent, const std::string &caption, std::string *folder = nullptr) {
