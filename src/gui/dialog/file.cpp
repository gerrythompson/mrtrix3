...
std::string get_file(QWidget *parent,
                     ...
                     std::string *folder) {
  QString qstring = QFileDialog::getOpenFileName(parent,
                                                 qstr(caption),
                                                 folder ? qstr(*folder) : QString(),
                                                 qstr(filter),
                                                 0,
...
vector<std::string> get_files(QWidget *parent,
                              ...
                              const std::string &filter,
                              std::string *folder) {
  QStringList qlist = QFileDialog::getOpenFileNames(parent,
                                                    qstr(caption),
                                                    folder ? qstr(*folder) : QString(),
                                                    qstr(filter),
                                                    0,
