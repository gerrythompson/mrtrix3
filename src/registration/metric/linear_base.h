...
public:
  ...
  /** requires_precompute:
    ...
    type_trait to distinguish metric types that require a call to precompute before the operator()
    is called evaluate loops over processed_image instead of midway_image
  */
  ...
  /** requires_initialisation:
    ...
    type_trait to distinguish metric types that require a call to init (im1, im2) before the
    operator() is called */
