...
// contrast_updated[tissue].start is relative to cropped image. contrast and contrast_updated can be
// identical
template <class ImageType>
FORCE_INLINE ImageType
multi_resolution_lmax(ImageType &input,
                      const default_type scale_factor,
