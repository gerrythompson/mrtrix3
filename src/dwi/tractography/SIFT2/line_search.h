...
// New line search functor for when per-streamline projections and per-fixel correlation terms are
// not calculated Instead, the correlation term for the line search is derived using the TD fraction
// only
