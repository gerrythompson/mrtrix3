...
// If the sum of tissue probabilities is below this threshold, the image is being exited, so a
// boolean flag is thrown The values will however still be accessible
