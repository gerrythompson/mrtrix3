...
inline Vertex
normal(const Vertex &one, const Vertex &two, const Vertex &three, const Vertex &four) {
...
inline default_type
area(const Vertex &one, const Vertex &two, const Vertex &three, const Vertex &four) {
