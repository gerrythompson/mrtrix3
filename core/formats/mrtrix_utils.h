...
// Read generic image header information - common between conventional, compressed and sparse
// formats
...
//   by read_mrtrix_header(), and are therefore erased by this function so that they do not
//   propagate into new images created using this header
