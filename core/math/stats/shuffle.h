...
public:
  ...
  // First version reads command-line options in order to determine parameters prior to running
  // initialise();
...
private:
  ...
  void generate_all_signflips(const size_t num_rows, const index_array_type &blocks);
