...
default_type erfinv(const default_type p) {
  ...
  public:
    Shared() : m_Y(0.0891314744949340820313) {
      ...
      m_Q << 1.0, -0.970005043303290640362, -1.56574558234175846809, 1.56221558398423026363,
...
default_type erfcinv(const default_type q) {
  ...
  public:
    Shared() : N(6), m_Y(N), m_P(N), m_Q(N) {
      ...
      m_P[0].resize(9);
      m_P[0] << -0.202433508355938759655, 0.105264680699391713268, 8.37050328343119927838,
      ...
      m_Q[0].resize(9);
      m_Q[0] << 1.0, 6.24264124854247537712, 3.9713437953343869095, -28.6608180499800029974,
          -20.1432634680485188801, 48.5609213108739935468, 10.8268667355460159008,
          -22.6436933413139721736, 1.72114765761200282724;
      // Region 1: x < 3
      m_Y[1] = 0.807220458984375;
      m_P[1].resize(11);
      m_P[1] << -0.131102781679951906451, -0.163794047193317060787, 0.117030156341995252019,
      ...
      m_Q[1].resize(8);
      m_Q[1] << 1.0, 3.46625407242567245975, 5.38168345707006855425, 4.77846592945843778382,
          2.59301921623620271374, 0.848854343457902036425, 0.152264338295331783612,
      ...
      m_Q[2].resize(7);
      m_Q[2] << 1.0, 1.3653349817554063097, 0.762059164553623404043, 0.220091105764131249824,
      ...
      m_Q[5].resize(7);
      m_Q[5] << 1.0, 0.0845746234001899436914, 0.00282092984726264681981,
