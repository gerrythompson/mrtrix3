...
//! This class provides access to the voxel intensities of a data set, using tri-linear
//! interpolation.
...
public:
  ...
  LinearInterp(const ImageType &parent,
               value_type value_when_out_of_bounds = Base<ImageType>::default_out_of_bounds_value())
      : LinearInterpBase<ImageType, LinearInterpProcessingType::Value>(parent,
...
public:
  ...
  LinearInterp(const ImageType &parent,
               value_type value_when_out_of_bounds = Base<ImageType>::default_out_of_bounds_value())
      : LinearInterpBase<ImageType, LinearInterpProcessingType::Derivative>(
...
public:
  ...
  LinearInterp(const ImageType &parent,
      ...
      : LinearInterpBase<ImageType, LinearInterpProcessingType::ValueAndDerivative>(
            parent, value_when_out_of_bounds),
        wrt_scanner_transform(Transform::scanner2image.linear() * voxelsize.inverse()) {
    if (ImageType::ndim() == 4) {
